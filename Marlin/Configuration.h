...
#define STRING_CONFIG_H_AUTHOR "(pjvdl, Ender-5 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-5 Pro Paul 4.2.2"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 44, 3, 0.00 }
